...
export default defineConfig({
  ...
  plugins: [
    ...
    monkey({
      ...
      userscript: {
        name: {
          '': 'Twitter Web Exporter (Custom)',
          'zh-CN': 'Twitter 数据导出工具 (Custom)',
          'zh-TW': 'Twitter 資料匯出工具 (Custom)',
          ja: 'Twitter データエクスポーター (Custom)',
        },
        description: {
        ...
        namespace: 'https://github.com/alumican',
        ...
        updateURL:
          'https://github.com/alumican/twitter-web-exporter/releases/latest/download/twitter-web-exporter.user.js',
        downloadURL:
          'https://github.com/alumican/twitter-web-exporter/releases/latest/download/twitter-web-exporter.user.js',
        require: [
